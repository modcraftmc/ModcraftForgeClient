...
public class DisplayWindow implements ImmediateWindowProvider {
    ...
    public Runnable initialize(String[] arguments) {
        ...
        var widthopt = parser.accepts("width")
                ...
                .defaultsTo(854); //TODO: config
        var heightopt = parser.accepts("height")
                .withRequiredArg().ofType(Integer.class)
                .defaultsTo(480); //TODO: config
        ...
        this.maximized = parsed.has(maximizedopt) || false; //TODO: config
    ...
    private void initRender(final @Nullable String mcVersion, final String forgeVersion) {
        ...
        if (false || (date.get(Calendar.MONTH) == Calendar.APRIL && date.get(Calendar.DAY_OF_MONTH) == 1)) //TODO: config
    ...
    public void initWindow(@Nullable String mcVersion) {
        ...
        int versidx = 0;
        var skipVersions = List.of(); //FMLConfig.<String>getListConfigValue(FMLConfig.ConfigValue.EARLY_WINDOW_SKIP_GL_VERSIONS); TODO: config
