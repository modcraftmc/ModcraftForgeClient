 ...
 * game loading cycle. We completely replace the {@link #render(PoseStack, int, int, float)} call from the parent
...
public class ForgeLoadingOverlay extends LoadingOverlay {
    ...
    @Override
    public void render(final @NotNull PoseStack graphics, final int mouseX, final int mouseY, final float partialTick) {
        ...
        Matrix4f matrix4f = Matrix4f.orthographic(0.0F, fbWidth, fbHeight, 0.0F, -0.1f, 0.1f);
